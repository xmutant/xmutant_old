...
export const ContainerScroll = ({ users, titleComponent }) => {
  ...
  return (
    <div className="h-[65rem] flex items-center justify-center relative p-20" ref={containerRef}>
...
export const Card = ({ rotate, scale, translate, users }) => {
  return (
    <motion.div style={{ rotateX: rotate, scale, boxShadow: "0 0 #0000004d, 0 9px 20px #0000004a, 0 37px 37px #00000042, 0 84px 50px #00000026, 0 149px 60px #0000000a, 0 233px 65px #00000003" }} className="max-w-5xl -mt-8 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-8 bg-[#222222] rounded-[30px] shadow-2xl">
        ...
        {users.map((user, idx) => (
          <article key={idx} className="relative">
            <div className="block rounded-2.5xl border border-jacarta-100 bg-white p-2  transition-shadow hover:shadow-lg dark:border-jacarta-700 dark:bg-jacarta-700">
              ...
              <div className="p-1">
                <h2 className=" dark:text-white text-black  font-semibold   text-sm">{user.collection}</h2>
                <h3 className="  text-xs text-black dark:text-white">{user.name}</h3>
              </div>
